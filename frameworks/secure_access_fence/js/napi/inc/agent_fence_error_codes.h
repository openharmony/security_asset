...
typedef enum {
    ...
    OPERATION_FAILED_UNDER_SCREEN_LOCK = 24010006,
    REMOTE_TOKEN_EXPIRED = 24010007,
    REMOTE_DEVICE_UNTRUSTED = 24010008,
    LACK_AUTH_TOKEN = 24010009,
    AUTH_TOKEN_EXPIRED = 24010010,
} AgentFenceErrorCode;
