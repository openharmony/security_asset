...
const PARAM_HW_ACCOUNT_ID: &str = "HwAccountId";
...
impl TicketKeyManager for AccountBasedTicketKeyManager {
    fn derive_ticket_session_key(&self, os_account_id: i32, hw_account_id: &str, derive_factor: &[u8])
    -> Result<Vec<u8>> {
        ...
        params.insert(PARAM_HW_ACCOUNT_ID, Value::String(hw_account_id.to_string()));
