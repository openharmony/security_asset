        ...
        unsafe {
            ...
            if self.lib.borrow().is_none() {
                ...
                match libloading::Library::new("libasset_ext_ffi.z.so") {
                    ...
                    Err(err) => {
                        ...
                        return macros_lib::log_throw_error!(macros_lib::hisysevent::function!(), ErrCode::InvalidArgument, "dlopen failed {}", err);
                    },
                };
            }

            let Some(ref lib) = *self.lib.borrow() else {
                return macros_lib::log_throw_error!(macros_lib::hisysevent::function!(), ErrCode::InvalidArgument, "unexpected error");
            };
                ...
                .get::<libloading::Symbol<unsafe extern "C" fn() -> *mut dyn IAssetPlugin>>(b"_create_plugin")
            {
                ...
                Err(err) => {
                    ...
                    return macros_lib::log_throw_error!(macros_lib::hisysevent::function!(), ErrCode::InvalidArgument, "dlsym failed {}", err);
                },
            };
            ...
            if plugin_ptr.is_null() {
                ...
                return macros_lib::log_throw_error!(macros_lib::hisysevent::function!(), ErrCode::InvalidArgument, "_create_plugin return null.");
            }
        ...
        match CString::new(column_key) {
            Ok(key) => {
                ...
                if result == DATASHARE_SUCCESS {
                    ...
                    macros_lib::log_throw_error!(macros_lib::hisysevent::function!(), ErrCode::DatabaseError, "[query_value] query settingsdata.db failed")
                }
            },
            Err(_) => {
                macros_lib::log_throw_error!(macros_lib::hisysevent::function!(), ErrCode::InvalidArgument, "[query_value] create CString failed")
            }
        }
    }
